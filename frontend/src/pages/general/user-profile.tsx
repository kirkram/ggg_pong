  ...
  return (
    ...
    >
      ...
      <div className="bg-black bg-opacity-70 backdrop-blur-md p-8 rounded-xl max-w-5xl mx-auto mt-20">
        <h1 className="text-4xl font-bold mb-6 text-center">Gang Profile: {profile.username}</h1>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="text-left">
            ...
            <p className="text-xl mt-2"><strong>First Name:</strong> {profile.firstName || 'N/A'}</p>
            <p className="text-xl mt-2"><strong>Last Name:</strong> {profile.lastName || 'N/A'}</p>
            <p className="text-xl mt-2"><strong>Birth Date:</strong> {profile.dateOfBirth || 'N/A'}</p>
            <p className="text-xl mt-2"><strong>Gender:</strong> {profile.gender}</p>
            <p className="text-xl mt-2"><strong>Language:</strong> {profile.language}</p>
            <p className="text-xl mt-2"><strong>Fav Avatar:</strong> {profile.favAvatar}</p>
          </div>
        </div>
      </div>
    </div>
