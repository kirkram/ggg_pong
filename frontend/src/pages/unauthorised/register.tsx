        ...
        <div className="flex h-screen">
            ...
            {backendMessage ? (
                <div className="w-1/2 flex flex-col justify-center p-12 bg-white">
                    ...
                    {error ? (
                        <div className="text-red-500">Error: {error.response?.data?.error || "Something went wrong"}</div>
                    ) : null}
                    <button 
                ...
                <div className="w-1/2 flex flex-col justify-center p-12 bg-white">
                    <h2 className="text-4xl font-bold mb-6">Join the Ping Pong Championship!</h2>
                    {error ? (
                        <div className="text-red-500">Error: {error.response?.data?.error || "Something went wrong"}</div>
                    ) : null}
